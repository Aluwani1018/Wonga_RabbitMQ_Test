...
namespace RabbitMQ.Mock
{
    public class MockModel : IModel
    {
        ...
        #region Ctor
        public MockModel(RabbitServer server)
        {
            _server = server;
        } 
        #endregion
        ...
        #region Propertie(s)
        /// <summary>
        /// gets and sets defaulr consumer
        /// </summary>
        public IBasicConsumer DefaultConsumer { get; set; }

        /// <summary>
        /// gets and sets close reason
        /// </summary>
        public ShutdownEventArgs CloseReason { get; set; }

        /// <summary>
        /// gets and sets isopen
        /// </summary>
        public bool IsOpen { get; set; }

        /// <summary>
        /// gets and sets isclosed
        /// </summary>
        public bool IsClosed { get; set; }

        /// <summary>
        /// ges and sets next publish sequence no
        /// </summary>
        public ulong NextPublishSeqNo { get; set; }

        /// <summary>
        /// gets and sets continuation timeout
        /// </summary>
        public TimeSpan ContinuationTimeout { get; set; }

        /// <summary>
        /// gets and sets apply prefetch to all channel
        /// </summary>
        public bool ApplyPrefetchToAllChannels { get; private set; }

        /// <summary>
        /// gets and sets prefetch count
        /// </summary>
        public ushort PrefetchCount { get; private set; }

        /// <summary>
        /// gets and sets prefetch size
        /// </summary>
        public uint PrefetchSize { get; private set; }

        /// <summary>
        /// gets and sets ischannelflowactive
        /// </summary>
        ...
        public void ExchangeDeclare(string exchange, string type, bool durable, bool autoDelete, IDictionary<string, object> arguments)
        {
            var exchangeInstance = new Exchange
            {
                ...
                Arguments = arguments as IDictionary<string, object>
            };
        ...
        public QueueDeclareOk QueueDeclare(string queue, bool durable, bool exclusive, bool autoDelete, IDictionary<string, object> arguments)
        {
            var queueInstance = new Queue
            {
                ...
                Arguments = arguments as Dictionary<string, object>
            };
        ...
        #region Event(s)/ Event Handler(s)
